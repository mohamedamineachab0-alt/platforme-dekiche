  ...
  return (
    <div className="space-y-8 font-arabic" dir="rtl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-3xl border border-amber-100 shadow-md flex items-center justify-between">
          <div>
            <p className="text-sm font-bold text-slate-700 mb-1">إجمالي المداخيل الإجمالية</p>
            <p className="text-3xl font-black text-slate-900">{platformTotalRevenue.toLocaleString('ar-DZ')} دج</p>
          </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-amber-100 shadow-md flex items-center justify-between">
          <div>
            <p className="text-sm font-bold text-slate-700 mb-1">إجمالي الاشتراكات المفعلة</p>
      ...
      <div id="revenue-table-container" className="bg-white rounded-3xl border border-amber-100 shadow-md overflow-hidden p-6">
            ...
            <tbody className="divide-y divide-slate-100">
              {ledger.length === 0 ? (
                ...
                ledger.map((teacher, index) => (
                  <tr key={teacher.teacherId} className="hover:bg-amber-50/30 transition-colors bg-white">
                    ...
                    <td className="px-6 py-4">
                      <span className="bg-amber-100 text-amber-900 font-black px-3 py-1.5 rounded-lg shadow-sm">
        ...
        <div className="mt-8 pt-4 border-t border-amber-50 flex justify-between items-center text-slate-500 text-xs font-bold px-4">
