  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 font-sans text-[#1E1B4B]" dir="rtl">
      <HeroBanner
        ...
        description="تصفح الدروس والتمارين الخاصة بالمواد المقررة لشعبتك مع إمكانية الدخول وتفعيل الاشتراكات"
                ...
                <div className="absolute top-3 left-3">
                  {isEnrolled || isFree ? (
                    <span className="flex items-center gap-1 rounded-xl bg-emerald-500/90 px-3 py-1 text-xs font-black text-white backdrop-blur-md">
                      <PlayCircle className="h-3 w-3" /> مجانية
                    </span>
                  ) : isExpired ? (
                ...
                <div className="border-t border-[#EDE9FE] pt-2">
                  {isEnrolled || isFree ? (
                    <Link
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-full bg-[#6D28D9] py-3 font-bold text-white transition hover:bg-[#5B21B6]"
                    >
                    ...
                    <form action={redeemAccessCode} className="space-y-2.5">
                      ...
                      <button
                        type="submit"
                        className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-full bg-[#6D28D9] py-2.5 text-xs font-bold text-white transition hover:bg-[#5B21B6]"
                      >
