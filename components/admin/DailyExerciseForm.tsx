    ...
    <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 sticky top-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button  
          type="submit" 
          disabled={uploading}
          className="w-full bg-[#6D28D9] hover:bg-[#1E1B4B] text-white font-black font-bold py-3 rounded-xl transition-all shadow-sm shadow-amber-500/20 mt-4 disabled:opacity-50"
        >
