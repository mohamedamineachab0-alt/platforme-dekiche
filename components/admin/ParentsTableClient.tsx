                ...
                <form onSubmit={handleSendMessage} className="space-y-4">
                  ...
                  <div className="pt-2 flex justify-end gap-3">
                    ...
                    <button 
                      ...
                      className="flex items-center justify-center gap-2 px-6 py-2.5 bg-[#6D28D9] hover:bg-[#1E1B4B] text-white font-black font-black rounded-xl transition-all shadow-sm hover:shadow-md disabled:opacity-50"
                    >
